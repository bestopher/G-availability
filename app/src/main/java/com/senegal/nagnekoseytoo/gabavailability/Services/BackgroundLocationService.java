package com.senegal.nagnekoseytoo.gabavailability.Services;
...
import com.senegal.nagnekoseytoo.gabavailability.Utils.Files;
import com.senegal.nagnekoseytoo.gabavailability.Utils.Utils;
    ...
    private class LocationListener implements
        ...
        public void onLocationChanged(Location location) {
           ...
           // Flog.d(_L_, "" + location);
            ...
            String extras = "_GoogleApi" + "_Lat_" + currentLat + "_Long_" + currentLng;
                ...
                case 8: {
                    ...
                    if (grantResults.length > 0
                      ...
                      //  Flog.d(TAG+"|onRequestPermissionsResult |GoogleApi_PERMISSION_GRANTED", permissions[0]);
                        ...
                        String extras = "GoogleApi";
                        Files.createFlyFile(android_id, "_RequestFailed_grantResult="+ grantResults[1], extras);
